...
public class FeignRequestResponseLoggingConifguration {
    ...
    @Bean
    public Logger feignLogger(RequestDataProvider requestDataProvider,
    ...
    public RequestDataProvider requestDataProvider(
            @Value("${rest.client.feign.logging.payload.expirationTimeout:20000}") int requestDataExpirationTimeout) {
