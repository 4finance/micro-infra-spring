...
interface HeadersSetting<T> extends Executable<T> {
    ...
    /**
     * Sets {@link MediaType} for the {@link HttpHeaders#CONTENT_TYPE} header 
     *
     * @param mediaType
     *
     * @return itself
    ...
    /**
     * Sets {@link MediaType#APPLICATION_JSON_VALUE} for the {@link HttpHeaders#CONTENT_TYPE} header 
     *
     * @return itself
     */
    ...
    /**
     * Sets {@link MediaType#APPLICATION_XML_VALUE} for the {@link HttpHeaders#CONTENT_TYPE} header 
     *
     * @return itself
     */
     ...
     * @return itself
     */
    HeadersSetting<T> authorization(String authorization)

    /**
     * Sets basic authorization value for the {@link HttpHeaders#AUTHORIZATION} header
     *
     * @param username
     * @param password
     *
     * @return itself
     */
    HeadersSetting<T> basicAuthorization(String username, String password)
