...
interface ResponseReceivingOptionsMethod extends HeadersHaving<ResponseReceivingOptionsMethod>, ResponseExtracting, AllowHeaderReceiving, Executable<ResponseReceivingOptionsMethod> {
