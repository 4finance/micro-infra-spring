package repackaged.com.mangofactory.swagger.plugin;
...
import repackaged.com.mangofactory.swagger.ordering.ResourceListingLexicographicalOrdering;
import repackaged.com.mangofactory.swagger.readers.operation.RequestMappingReader;
import repackaged.com.mangofactory.swagger.scanners.*;
...
import repackaged.com.mangofactory.swagger.core.SwaggerApiResourceListing;
...
public class SwaggerSpringMvcPlugin {
   ...
   * SwaggerSpringMvcPlugin#authorizationContext
   *
   ...
   * Listing.
   *
   * Under the hood, <code>RequestMappingPatternMatcher</code>is used to match a
   ...
   * @see SpringSwaggerConfig#defaultResponseMessages()
   */
   ...
   * @return this SwaggerSpringMvcPlugin
   * @see SpringSwaggerConfig#defaultIgnorableParameterTypes()
   */
   ...
   * @return this SwaggerSpringMvcPlugin
   * @see ApiListingReferenceScanner#scanSpringRequestMappings()
   */
   ...
   * model.
   *
   * @param customAnnotationReaders list of {@link RequestMappingReader}
   * @return this SwaggerSpringMvcPlugin
   */
   ...
   *                                     {@link RegexRequestMappingPatternMatcher} and
   *                                     {@link AntRequestMappingPatternMatcher}
   * @return this SwaggerSpringMvcPlugin
   */
